...
class CarRacing:
    ...
    def initialize(self):
        ...
        self.carImg = pygame.image.load('.\\car_game_img\\car.png')
        self.car_x_coordinate = (self.display_width * 0.45)
        self.car_y_coordinate = (self.display_height * 0.8)
        self.car_width = 49

        # enemy_car
        self.enemy_car = pygame.image.load('.\\car_game_img\\enemy_car_1.png')
        ...
        # Background
        self.bgImg = pygame.image.load(".\\car_game_img\\back_ground.jpg")
    ...
    def racing_window(self):
        ...
        pygame.display.set_caption('Car Race -- Manu')
        self.run_car()
        ...
        while not self.crashed:
            ...
            if self.car_y_coordinate < self.enemy_car_starty + self.enemy_car_height:
                if self.car_x_coordinate > self.enemy_car_startx and self.car_x_coordinate < self.enemy_car_startx + self.enemy_car_width or self.car_x_coordinate + self.car_width > self.enemy_car_startx and self.car_x_coordinate + self.car_width < self.enemy_car_startx + self.enemy_car_width:
                    self.crashed = True
                    self.display_message("khatam Tata Good bye gya !!!")
    ...
    def display_message(self, msg):
        font = pygame.font.SysFont("comicsansms", 52, True)
    ...
    def display_credit(self):
        ...
        text = font.render("Manu", True, self.white)
